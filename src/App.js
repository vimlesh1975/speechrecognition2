  ...
  return (<div style={{ textAlign: 'center' }}>
    <div style={{ width: '95%' }}>
      ...
      <div>
        ...
        <textarea value={currentText} onChange={e => setcurrentText(e.target.value)} style={{ width: '95%', height: 350 }} ></textarea>
      </div>
    </div>
    <div>
      <div style={{ border: '1px solid red', width: '95%', height: 250 }}>
